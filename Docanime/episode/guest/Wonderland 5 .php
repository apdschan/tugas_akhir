...
<div class = "banner">
    <button  class = "Banner-button prev" data-Banner-button = "prev"><a href = "../../guest/homepage/ListGenre.php"><img src = "../../img/Back.png" width="40px"></img></a></button>
    <button class = "Banner-button next" data-Banner-button = "next"><a href = "../../guest/homepage/Homepage.php"><img src = "../../img/home.png" width="40px" ></img></a></button>
...
<div class = "containerr">
    <?php
                                include "../../guest/homepage/koneksi.php"; //panggil file koneksi
