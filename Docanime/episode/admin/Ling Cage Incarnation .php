...
$query="SELECT * FROM  tbl_film where nama_film = 'Ling Cage Incarnation ' and episode = '1'"; //buat query sql
...
<div class = "banner">
    ...
    <button class = "Banner-button next" data-Banner-button = "next"><a href = "../../admin/homepage/Homepage.php"><img src = "../../img/home.png" width="40px" ></img></a></button>
        ...
        <table class = "tableeee"><tr></tr><tr></tr><tr></tr>
...
include '../koneksi.php';
$isi=$_POST['komen']; 
$nama_film = 'Ling Cage Incarnation ';
$eps = '1';
@$kirim =$_POST['kirim'];
...
<?php
include "../koneksi.php"; 
$query3="SELECT * FROM  tbl_komentar where nama_film = 'Ling Cage Incarnation ' and episode = '1' and isi_komentar != ''"; 
