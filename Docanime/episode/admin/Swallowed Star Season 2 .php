...
$query="SELECT * FROM  tbl_film where nama_film = 'Swallowed Star Season 2 ' and episode = '1'"; //buat query sql
...
<div class = "banner">
    ...
    <button class = "Banner-button next" data-Banner-button = "next"><a href = "../../admin/homepage/Homepage.php"><img src = "../../img/home.png" width="40px" ></img></a></button>
        ...
        <tr></tr><tr></tr><tr><td></td></tr></table>
        <table class = "tableee"><tr><td></td></tr><tr><td></td></tr>
        <tr><td><ul type = circle><li class = "teks"><?php echo 'Studio Film'.  ' : ' . $data['studio_film'];?></li></ul></tr>
        </table>
        <table class = "tableeee"><tr><td></td></tr><tr><td></td></tr>
...
include '../koneksi.php';
$isi=$_POST['komen']; 
$nama_film = 'Swallowed Star Season 2 ';
$eps = '1';
@$kirim =$_POST['kirim'];
...
<?php
include "../koneksi.php"; 
$query3="SELECT * FROM  tbl_komentar where nama_film = 'Swallowed Star Season 2 ' and episode = '1' and isi_komentar != ''"; 
