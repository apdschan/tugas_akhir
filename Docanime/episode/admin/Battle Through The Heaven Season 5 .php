...
$query="SELECT * FROM  tbl_film where nama_film = 'Battle Through The Heaven Season 5 ' and episode = '1'"; //buat query sql
...
<div class = "banner">
    <button  class = "Banner-button prev" data-Banner-button = "prev"><a href = "../../admin/homepage/ListGenre.php"><img src = "../../img/Back.png" width="40px"></img></a></button>
    <button class = "Banner-button next" data-Banner-button = "next"><a href = "../../admin/homepage/Homepage.php"><img src = "../../img/home.png" width="40px" ></img></a></button>
        <span class = "Terpopuler">
        <table border = "0px" cellspacing ="8px">
            <tr><td><?php echo $data['nama_film']?></td></tr><tr></tr>
        </table>
        ...
        <tr><td><ul type = circle><li class = "teks"><?php echo 'Studio Film'.  ' : ' . $data['studio_film'];?></li></ul></tr><tr></tr><tr></tr><tr></tr>
        </table>
        <table class = "tableeee"><tr><td><br></td></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
...
<tr><td rowspan = "3"  class = "hooh"><img class = "img" src = "../../img/logod.png" width = "60px"></img></td><td width = '91.3%'>Admin Docanime</td></tr>
<tr><td><textarea rows = 1 class = "inputt" name = 'komen'></textarea><input type = "submit" class = "kirimm" value = "kirim" name = 'kirim'></input></td><tr>
<?php
error_reporting(0);
include '../koneksi.php';
$isi=$_POST['komen']; 
$nama_film = 'Battle Through The Heaven Season 5 ';
$eps = '1';
@$kirim =$_POST['kirim'];
$query="INSERT INTO tbl_komentar (id_komentar,nama_film,episode,isi_komentar) VALUES (id_komentar,'$nama_film','$eps','$isi')";
$hasil=mysqli_query($koneksi_db, $query); 
?>
<?php
include "../koneksi.php"; 
$query3="SELECT * FROM  tbl_komentar where nama_film = 'Battle Through The Heaven Season 5 ' and episode = '1'"; 
$hasil3= mysqli_query($koneksi_db,$query3);
if ($hasil3 !== ""){
while($data2=mysqli_fetch_array($hasil3)){
?>
<tr><td rowspan = "3"  class = "hooh"><img class = "imgg" src = "../../img/logod.png" width = "60px"></img></td><td width = '91.3%'>Admin Docanime</td></tr><tr><td class = "issi"><?php echo $data2['isi_komentar'];?></td><tr>
<?php
}};
?>
</table>
