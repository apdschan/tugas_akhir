...
$query="SELECT * FROM  tbl_film where nama_film = 'Haikyuu! Season 2 ' and episode = '1'"; //buat query sql
...
<?php
include "../koneksi.php"; 
$query3="SELECT * FROM  tbl_komentar where nama_film = 'Haikyuu! Season 2 ' and episode = '1' and isi_komentar != ''"; 
