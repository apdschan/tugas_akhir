...
$query="SELECT * FROM  tbl_film where nama_film = 'Wonderland 5 ' and episode = '1'"; //buat query sql
...
<div class = "banner">
    ...
    <button class = "Banner-button next" data-Banner-button = "next"><a href = "../../admin/homepage/Homepage.php"><img src = "../../img/home.png" width="40px" ></img></a></button>
        ...
        <table class = "tableee"><tr><td></td></tr><tr></tr><tr></tr>
        <tr><td><ul type = circle><li class = "teks"><?php echo 'Studio Film'.  ' : ' . $data['studio_film'];?></li></ul></tr><tr></tr>
        <tr></tr><tr></tr><tr></tr><tr><br></tr>
        </table>
        <table class = "tableeee">
        <tr><br><td><button class = "Genreee" >Rating <?php echo $data['rating_film']?></button></td></tr>
        </table>
        </span>
...
include '../koneksi.php';
$isi=$_POST['komen']; 
$nama_film = 'Wonderland 5 ';
$eps = '1';
@$kirim =$_POST['kirim'];
$query="INSERT INTO tbl_komentar (id_komentar,nama_film,episode,username,isi_komentar) VALUES (id_komentar,'$nama_film','$eps','Admin Docanime','$isi')";
$hasil=mysqli_query($koneksi_db, $query); 
?>
<?php
include "../koneksi.php"; 
$query3="SELECT * FROM  tbl_komentar where nama_film = 'Wonderland 5 ' and episode = '1' and isi_komentar != ''"; 
