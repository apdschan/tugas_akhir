...
<td width="91%"></td>
<td width="10%"><center><button class= crud><a style = "text-decoration:none" href = "../../Login.php"  type = "submit" value = "Manage">Logout</center></a></button></td>
<td><a href = 'edit profil.php'><img src = "../../img/Logod.png" width="31px"></img></a></td>
<td><td>
</tr>
</table>
</header>
...
<div class = "Banner" data-Banner>
    ...
    <ul data-slides>
        ...
        <button class = "TontonSekarang"><a  style = "text-decoration:none; color : white" href = "../../episode/user/Swallowed Star Season 2 .php">Tonton Sekarang</a></button>
        <img src = "../../img/Next.png" width="25px" class = "Hehe"></img>
        </span>
...
<div class = "container2">
    <?php
                                include "koneksi.php"; //panggil file koneksi
                                $query="SELECT * FROM  tbl_film where nama_film != 'Battle Through The Heaven Season 5' and genre1 = 'Petualangan' or genre2 = 'Petualangan' or genre3 = 'Petualangan'"; //buat query sql
                                $hasil= mysqli_query($koneksi_db,$query);
                                while ($data=mysqli_fetch_array ($hasil)){?>
    <div class = "conent3">
        <div class = "card">
